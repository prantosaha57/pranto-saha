export default function ContactLinkBox({ icon, label, value, href }) {
  ...
  return (
    ...
    >
      <div className="text-[1.5rem] w-11 h-11 rounded-xl bg-surface flex items-center justify-center transition-colors duration-200 group-hover:bg-accent/[0.07]">{icon}</div>
      <div>
